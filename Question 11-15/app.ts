...
let firstNames: string[] = ["Waqar", "Ruwaifa", "Salman", "Khubaib"];
...
let friendsName: string[] = ["Waqar", "Ruwaifa", "Salman", "Khubaib"];
...
let vehicleModes: string[] = ["Honda Motorcycle", "Tesla Model S", "BMW i8", "Yamaha R6"];

for (let i = 0; i < vehicleModes.length; i++) {
    console.log(`I would like to own a ${vehicleModes[i]}.`);
}
...
let guestList: string[] = ["Albert Einstein", "Martin Luther King Jr.", "Malala Yousafzai"];
