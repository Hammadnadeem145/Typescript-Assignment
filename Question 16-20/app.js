...
//code:
let newGuestList = ["Albert Einstein", "Martin Luther King Jr.", "Marie Curie", "Stephen Hawking", "Nelson Mandela", "Bill Gates", "Thomas Edison", "Steve Jobs"];
...
//code:
//Original array
let locations = ["Paris", "Santorini", "Maui", "Cape Town", "Sydney"];
...
let rivers = ["Nile", "Amazon", "Yangtze", "Mississippi", "Yenisei"];
//Print the array
console.log("List of rivers: " + rivers);
//Create an array of countries
let countries = ["Dubai", "USA", "China", "Russia", "Brazil"];
//Print the array
